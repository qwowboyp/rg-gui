...
namespace Peter
{
    ...
    public class ShellContextMenu : NativeWindow
    {
        ...
        protected IntPtr[]? GetPIDLs(IEnumerable<FileInfo> arrFI)
        {
            ...
            IntPtr[] arrPIDLs = new IntPtr[arrFI.Count()];
            int n = 0;
        ...
        private void InvokeContextMenuDefault(IEnumerable<FileInfo> arrFI)
        {
        ...
        public void ShowContextMenu(IEnumerable<FileInfo> files, Point pointScreen)
        {
            // Release all resources first.
            ReleaseAll();
        ...
        [DllImport("Shell32.dll")]
        static extern Int32 CDefFolderMenu_Create2(
            IntPtr pidlFolder,
            IntPtr hwnd,
            uint cidl,
